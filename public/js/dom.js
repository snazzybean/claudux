...
export const subagentOrbitEl = document.getElementById('subagentOrbit');
export const subagentPopoverEl = document.getElementById('subagentPopover');
export const subagentBackdropEl = document.getElementById('subagentBackdrop');
